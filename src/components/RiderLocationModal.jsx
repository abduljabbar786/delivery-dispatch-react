...
export default function RiderLocationModal({ rider, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4 overflow-y-auto animate-backdrop-fade-in" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      {/* Background overlay */}
      <div
      ...
      {/* Modal panel */}
      <div className="relative bg-white rounded-lg shadow-xl animate-modal-scale-in w-full max-w-4xl my-8">
          {/* Header */}
