...
export default function AddRiderModal({ onClose, onCreateRider }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4 animate-backdrop-fade-in">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full animate-modal-scale-in">
        {/* Header */}
